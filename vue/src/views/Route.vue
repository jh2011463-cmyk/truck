  ...
  <div class="route-management">
    <div class="header">
      ...
      <div class="operation-buttons">
        <el-button type="primary" @click="handleAdd" :disabled="listLoading || deleteLoading || formLoading">新增线路</el-button>
        <el-button type="success" @click="handleBatchOptimize" :loading="batchOptimizeLoading" :disabled="listLoading || deleteLoading || batchOptimizeLoading || optimizeLoading">批量优化</el-button>
        <el-button type="info" @click="handleExport" :loading="exportLoading" :disabled="listLoading || deleteLoading || exportLoading">导出数据</el-button>
      </div>
    </div>
    ...
    <div class="table-area">
      <el-table :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange" v-loading="listLoading">
        ...
        <el-table-column label="操作" width="350" fixed="right">
          <template slot-scope="scope">
            <el-button size="mini" @click="handleView(scope.row)" :disabled="listLoading || deleteLoading">查看</el-button>
            <el-button size="mini" type="primary" @click="handleEdit(scope.row)" :disabled="listLoading || deleteLoading">编辑</el-button>
            <el-button size="mini" type="success" @click="handleOptimize(scope.row)" :disabled="listLoading || deleteLoading">优化</el-button>
            <el-button size="mini" type="danger" @click="handleDelete(scope.row)" :loading="deleteLoading" :disabled="listLoading || batchOptimizeLoading">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
