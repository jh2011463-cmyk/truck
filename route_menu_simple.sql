...
INSERT INTO sys_menu (name, path, icon, description, pid, page_path, sort_num) 
VALUES ('线路列表', 'route', 'el-icon-document', '线路信息管理', 1, 'Route', 1);

INSERT INTO sys_menu (name, path, icon, description, pid, page_path, sort_num) 
VALUES ('线路规划', 'route-plan', 'el-icon-guide', '智能线路规划', 1, 'RoutePlan', 2);

INSERT INTO sys_menu (name, path, icon, description, pid, page_path, sort_num) 
VALUES ('线路分析', 'route-analysis', 'el-icon-data-analysis', '线路数据分析', 1, 'RouteAnalysis', 3);
