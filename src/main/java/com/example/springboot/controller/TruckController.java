...
public class TruckController {
    ...
    public Result save(@RequestBody Truck truck) {
        if (truck.getId() == null) {
            //truck.setTime(DateUtil.now());
            //truck.setUser(TokenUtils.getCurrentUser().getUsername());
        }
        truckService.saveOrUpdate(truck);
    ...
    public Result findUsable(){
        ...
        List<Truck> truckList = truckService.list(queryWrapper);
...
//        }
    ...
    */
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        String fileName = URLEncoder.encode("Truck信息表", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        List<Truck> list = reader.readAll(Truck.class);

        truckService.saveBatch(list);
        return Result.success();
    }
